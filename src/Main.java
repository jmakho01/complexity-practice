...
public class Main {
  ...
  // The time complexity is:
  // O(1 * n), where 1 is the word length and n is the amount of letters in the word
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // YOUR ANSWER HERE: O(n^3)  n = wordsA * wordsB * .equals 
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // YOUR ANSWER HERE: O(n), where n = wordsA = wordsB
  ...
  // YOUR ANSWER HERE: O(n^2), where n = names * n = names[i].equals(queryName)
  ...
  // YOUR ANSWER HERE: O(n^2), where n = for(String word : wordSet) * n = wordList.contains(word)
